...
if REGEN_DATASET == True or datasetNotFound:
    ...
    datasetTraining = customTorchTools.LoadTorchDataset(
        datasetSavePath, datasetName='TrainingDataset_'+TrainingDatasetTag)
    datasetValidation = customTorchTools.LoadTorchDataset(
...
if LOSS_TYPE == 0:
    lossFcn = customTorchTools.CustomLossFcn(
...
def objective(trial):
    ...
    with mlflow.start_run() as mlflow_run:
        ...
        validationDataset = DataLoader(
            datasetValidation, batch_size, shuffle=True, num_workers=2, pin_memory=True)
