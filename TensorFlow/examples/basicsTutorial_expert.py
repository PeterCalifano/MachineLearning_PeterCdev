...
# Add new dimension to arrary:
# Required because 2D convolutional layers in Tensorflow takes a 3D input: [height, width, channels]
# A grayscale image has 1 channel only, while astype converts the input to float32
