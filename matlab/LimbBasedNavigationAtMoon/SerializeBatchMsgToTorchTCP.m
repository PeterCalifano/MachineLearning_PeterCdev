function [dataLength, dataBufferToWrite] = SerializeBatchMsgToTorchTCP(i_strInputSamplesBatchStruct, ...
                                                                       i_ui32Nbatches)%#codegen
arguments
    i_ui32Nbatches               (
    i_strInputSamplesBatchStruct (i_ui32Nbatches, :) 
    
end
%% PROTOTYPE
% [dataLength, dataBufferToWrite] = SerializeMsgToTorchTCP(i_ui8flattenedWindow, ...
%     i_dSunDir_PixCoords, ...
